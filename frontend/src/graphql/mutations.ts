...
export const generateInstantConnectToken = /* GraphQL */ `
    mutation GenerateInstantConnectToken {
...
export const redeemInstantConnectToken = /* GraphQL */ `
    mutation RedeemInstantConnectToken($token: String!) {
        redeemInstantConnectToken(token: $token) {
            success
            message
            connectedUser {
                id
