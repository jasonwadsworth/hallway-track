...
export interface GoogleConfig {
    ...
    /**
     * Full ARN of the AWS Secrets Manager secret containing the Google OAuth Client Secret
     * Example: 'arn:aws:secretsmanager:us-west-2:123456789012:secret:hallway-track/google-client-secret-AbCdEf'
     *
     * To get the ARN, run:
     * aws secretsmanager describe-secret --secret-id hallway-track/google-client-secret --query 'ARN' --output text
     */
...
const accountConfigurations: AccountConfiguration = {
    '831926593673': {
        ...
        google: {
            ...
            clientSecretArn: 'arn:aws:secretsmanager:us-west-2:831926593673:secret:hallway-track/google-client-secret-Km7RQB',
        },
        oauth: {
            callbackUrls: [
            ...
            logoutUrls: ['https://d3ahxq34efx0ga.cloudfront.net', 'http://localhost:5173'],
        },
    },
    '602223306405': {
        badges: {
        ...
        google: {
            clientId: '474431897248-khmethsvop9vsk1s6cgt7jm3p22va641.apps.googleusercontent.com',
            clientSecretArn: 'arn:aws:secretsmanager:us-west-2:602223306405:secret:hallway-track/google-client-secret-kDufg6',
        },
        oauth: {
            callbackUrls: ['https://hallwaytrak.com'],
            logoutUrls: ['https://hallwaytrak.com'],
        },
    },
};
...
export function getConfigForAccount(accountId: string): HallwayTrackConfig {
    if (!accountId) {
        throw new Error('CDK_DEFAULT_ACCOUNT environment variable is required. ' + 'Please set this environment variable to your AWS account ID.');
    }
    ...
    if (config.customDomain?.domainName) {
        if (!isValidDomainName(config.customDomain.domainName)) {
            throw new Error(`Invalid domain name format: ${config.customDomain.domainName}. ` + 'Domain name must be a valid DNS name (e.g., example.com)');
        }
    }
