...
export class HallwayTrackStack extends cdk.Stack {
    ...
    constructor(scope: Construct, id: string, props: HallwayTrackStackProps) {
        ...
        if (config.google) {
            // Reference the secret using the full ARN from config
            const googleSecret = secretsmanager.Secret.fromSecretCompleteArn(this, 'GoogleClientSecret', config.google.clientSecretArn);
        ...
        const usersDataSource = this.api.addDynamoDbDataSource('UsersDataSource', this.usersTable);

        const connectionsDataSource = this.api.addDynamoDbDataSource('ConnectionsDataSource', this.connectionsTable);

        // Create Lambda function for contact link management
        const contactLinksFunction = new NodejsFunction(this, 'ContactLinksFunction', {
            runtime: lambda.Runtime.NODEJS_20_X,
            handler: 'handler',
        ...
        const contactLinksDataSource = this.api.addLambdaDataSource('ContactLinksDataSource', contactLinksFunction);

        // Create Lambda function for connections management
        const connectionsFunction = new NodejsFunction(this, 'ConnectionsFunction', {
            runtime: lambda.Runtime.NODEJS_20_X,
            handler: 'handler',
        ...
        const connectionsDataSourceLambda = this.api.addLambdaDataSource('ConnectionsDataSourceLambda', connectionsFunction);

        // Create Lambda function for connection requests management
        const connectionRequestsFunction = new NodejsFunction(this, 'ConnectionRequestsFunction', {
            runtime: lambda.Runtime.NODEJS_20_X,
            handler: 'handler',
        ...
        const badgeStreamProcessor = new NodejsFunction(this, 'BadgeStreamProcessor', {
            runtime: lambda.Runtime.NODEJS_20_X,
            handler: 'handler',
        ...
        const unifiedBadgeHandler = new NodejsFunction(this, 'UnifiedBadgeHandler', {
            runtime: lambda.Runtime.NODEJS_20_X,
            handler: 'handler',
        ...
        const badgeMigrationFunction = new NodejsFunction(this, 'BadgeMigrationFunction', {
            runtime: lambda.Runtime.NODEJS_20_X,
            handler: 'handler',
        ...
        const connectionMigrationFunction = new NodejsFunction(this, 'ConnectionMigrationFunction', {
            runtime: lambda.Runtime.NODEJS_20_X,
            handler: 'handler',
        ...
        const connectionRemovedHandler = new NodejsFunction(this, 'ConnectionRemovedHandler', {
            runtime: lambda.Runtime.NODEJS_20_X,
            handler: 'handler',
        ...
        const connectionRequestApprovedHandler = new NodejsFunction(this, 'ConnectionRequestApprovedHandler', {
            runtime: lambda.Runtime.NODEJS_20_X,
            handler: 'handler',
      ...
      `),
        ...
        this.api.addLambdaDataSource('LambdaDataSource', resolverFunction);
        ...
        usersDataSource.createResolver('UpdateDisplayNameResolver', {
            ...
            code: appsync.Code.fromAsset(path.join(__dirname, '../resolvers/Mutation.updateDisplayName.js')),
        });
        ...
        usersDataSource.createResolver('GetMyProfileResolver', {
            ...
            runtime: appsync.FunctionRuntime.JS_1_0_0,
            code: appsync.Code.fromAsset(path.join(__dirname, '../resolvers/Query.getMyProfile.js')),
        });
        ...
        usersDataSource.createResolver('AddContactLinkResolver', {
            ...
            runtime: appsync.FunctionRuntime.JS_1_0_0,
            code: appsync.Code.fromAsset(path.join(__dirname, '../resolvers/Mutation.addContactLink.js')),
        });
        ...
        usersDataSource.createResolver('GetPublicProfileResolver', {
            ...
            runtime: appsync.FunctionRuntime.JS_1_0_0,
            code: appsync.Code.fromAsset(path.join(__dirname, '../resolvers/Query.getPublicProfile.js')),
        });
        ...
        const checkConnectionFunction = new appsync.AppsyncFunction(this, 'CheckConnectionFunction', {
            ...
            runtime: appsync.FunctionRuntime.JS_1_0_0,
            code: appsync.Code.fromAsset(path.join(__dirname, '../resolvers/Query.getConnectedProfile.checkConnection.js')),
        });
        ...
        const getUserFunction = new appsync.AppsyncFunction(this, 'GetUserFunction', {
            ...
            runtime: appsync.FunctionRuntime.JS_1_0_0,
            code: appsync.Code.fromAsset(path.join(__dirname, '../resolvers/Query.getConnectedProfile.getUser.js')),
        });
        ...
        new appsync.Resolver(this, 'GetConnectedProfilePipelineResolver', {
            ...
            code: appsync.Code.fromAsset(path.join(__dirname, '../resolvers/Query.getConnectedProfile.before.js')),
        });
        ...
        connectionsDataSource.createResolver('CheckConnectionResolver', {
            ...
            runtime: appsync.FunctionRuntime.JS_1_0_0,
            code: appsync.Code.fromAsset(path.join(__dirname, '../resolvers/Query.checkConnection.js')),
        });
        ...
        connectionsDataSource.createResolver('GetMyConnectionsResolver', {
            ...
            runtime: appsync.FunctionRuntime.JS_1_0_0,
            code: appsync.Code.fromAsset(path.join(__dirname, '../resolvers/Query.getMyConnections.js')),
        });
        ...
        connectionsDataSource.createResolver('UpdateConnectionTagsResolver', {
            ...
            runtime: appsync.FunctionRuntime.JS_1_0_0,
            code: appsync.Code.fromAsset(path.join(__dirname, '../resolvers/Mutation.updateConnectionTags.js')),
        });
        ...
        connectionsDataSource.createResolver('UpdateConnectionNoteResolver', {
            ...
            runtime: appsync.FunctionRuntime.JS_1_0_0,
            code: appsync.Code.fromAsset(path.join(__dirname, '../resolvers/Mutation.updateConnectionNote.js')),
        });
        ...
        usersDataSource.createResolver('ConnectionConnectedUserResolver', {
            ...
            runtime: appsync.FunctionRuntime.JS_1_0_0,
            code: appsync.Code.fromAsset(path.join(__dirname, '../resolvers/Connection.connectedUser.js')),
        });
        ...
        usersDataSource.createResolver('ConnectionRequestInitiatorResolver', {
            ...
            fieldName: 'initiator',
            runtime: appsync.FunctionRuntime.JS_1_0_0,
            code: appsync.Code.fromAsset(path.join(__dirname, '../resolvers/ConnectionRequest.initiator.js')),
        });
        ...
        usersDataSource.createResolver('ConnectionRequestRecipientResolver', {
            ...
            fieldName: 'recipient',
            runtime: appsync.FunctionRuntime.JS_1_0_0,
            code: appsync.Code.fromAsset(path.join(__dirname, '../resolvers/ConnectionRequest.recipient.js')),
        });
        ...
        if (config.customDomain?.domainName) {
            ...
            const domainSecret = secretsmanager.Secret.fromSecretNameV2(this, 'DomainSecret', `hallway-track-domain-${this.account}`);
            ...
            this.certificate = acm.Certificate.fromCertificateArn(this, 'CustomDomainCertificate', certificateArn);
        ...
        noneDataSource.createResolver('GetLinkTypesResolver', {
            ...
            runtime: appsync.FunctionRuntime.JS_1_0_0,
            code: appsync.Code.fromAsset(path.join(__dirname, '../resolvers/Query.getLinkTypes.js')),
        });
